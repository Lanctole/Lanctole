# 👋 Привет! Я Александр Востриков

## 🚀 Backend Java Developer

Разрабатываю микросервисные приложения на Java и Spring Boot. Интересуюсь DevOps практиками, контейнеризацией и распределенными системами.
...
- 📧 Email: a.vostrikovwork@yandex.ru
- 📱 Telegram: [@vostrikovwork](https://t.me/vostrikovwork)
